                        ...
                        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <a style="color: rgb(113, 110, 110);font-size: 15px;font-weight: bold;"
                                    ...
                                    <span class="menu-title">AIDATLAR</span>
                                    <span class="menu-arrow"></span>
                            </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <a style="color: rgb(113, 110, 110);font-size: 15px;font-weight: bold;"
                                    ...
                                    <span class="menu-title">GİDERLER</span>
                                    <span class="menu-arrow"></span>
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                <!--begin:Menu link-->
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <a style="color: rgb(113, 110, 110);font-size: 15px;font-weight: bold;"
                                    ...
                                    <span class="menu-title">DAİRELER</span>
                                    <span class="menu-arrow"></span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <a style="color: rgb(113, 110, 110);font-size: 15px;font-weight: bold;"
                                    ...
                                    <span class="menu-title">SİTE BLOG DÜZENİ</span>
                                    <span class="menu-arrow"></span>
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                                        <h1 style="color: rgb(167, 167, 167);"
                                            class="page-heading d-flex flex-column justify-content-center  fw-bolder fs-1 lh-0">
                                            WELCOME TO THE SITE ADMINSTRATION PANEL!</h1>
                                        <!--end::Title-->
                                    </div>
                                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="10000">
                                                <img src="assets/about.png" class="d-block w-100" alt="...">
                                            </div>
