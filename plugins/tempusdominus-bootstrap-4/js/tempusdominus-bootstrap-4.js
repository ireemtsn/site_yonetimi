/*!@preserve
 * Tempus Dominus Bootstrap4 v5.39.0 (ht..//tempusdominus.githu../bootstr../)
 * Copyright 2016-2020 Jonathan Peterson and contributors
 * Licensed under MIT (ht..//github../tempusdom../bootstr../../ma../LICENSE)
 */
...
..//emitted
 ...
 ..// ReSharper restore InconsistentNaming
  ...
  var DateTimePicke../*#__PUR../function () {
../** @namespace eData.dateOptio../
...
..//private
    ...
    ..// case of calling setValue(null or false)
      ...
      if (this._options.stepping !== 1) {
        targetMoment.minutes(Math.round(targetMoment.minute../ this._options.stepping) * this._options.stepping).seconds(0);
      }
  ...
  ..//noinspection JSMethodCanBeStatic
    ...
    _proto._dataToOptions = function _dataToOptions() {
      ...
      $.each(this._options, function (key) {
        var attributeName = "date" + key.charAt(0).toUpperCase() + key.slice(..//todo data api key
  ...
  ..// (for example: options.enabledHours['2014-02-27'] === true)
    ...
    _proto._initFormatting = function _initFormatting() {
      var format = this._options.format || 'L LT',
          self = this;
      this.actualFormat = format.repl../(\[[^\[]*])|(\\)?(LTS|LT|LL?L?L?|l{1../g, function (formatInput) {
        return (self.isInitFormatting && self._options.date === null ? self.getMoment() : self._dates[0]).localeData().longDateFormat(formatInput) || formatInp..//todo taking the first date should be ok
      });
      ...
      this.use24Hours = this.actualFormat.toLowerCase().indexOf('a') < 1 && this.actualFormat.repl../\[../g, '').indexOf('h') < 1;
  ...
  return DateTimePicker;
}(jQuery, momen..//noinspection JSUnusedGlobalSymbols
...
var TempusDominusBootstrap4 = function ($) {
  ...
  var JQUERY_NO_CONFLICT = $.fn[DateTimePicker.NAME],
    ...
    if (!selector) {
      ...
      selecto../^#[../i.test(selector) ? selector : null;
    }
 ...
 ..// ReSharper disable once InconsistentNaming
  ...
  var TempusDominusBootstrap../*#__PUR../function (_DateTimePicker) {
    ...
    ..// Left and right logic
      ...
      if (horizontal === 'auto') {
        if (parent.width() < offset.left + self.widget.outerWidt../ 2 && offset.left + self.widget.outerWidth() > $(window).width()) {
          horizontal = 'right';
        } else {
          horizontal = 'left';
        }
    ...
    _proto2._getStartEndYear = function _getStartEndYear(factor, year) {
      var step = fac../ 10,
          startYear = Math.floor(y../ factor) * factor,
          endYear = startYear + step * 9,
          focusValue = Math.floor(y../ step) * step;
    ...
    ..//always display 42 days (should show 6 weeks)
      ...
      $('body').append('<div class="tempusdominus-bootstrap-datetimepicker-widget-day-click-glass-pane../div>');
        ...
        case 'selectDay':
          {
            ...
            if (this._options.allowMultidate) {
              ...
              if (index !== -1) {
                this._setValue(null, inde..//deselect multidate
  ...
  ..//public
    ...
    _proto2.disable = function disable() {
      ...
      if (this.input !== undefined) {
        this.input.prop('disabled', tru..//todo disable ../comp if input is null
      }
    };
    ...
    _proto2.enable = function enable() {
      ...
      if (this.input !== undefined) {
        this.input.prop('disabled', fals..//todo enable ../this if input is null
      }
    };
